...
require_once 'php-sentiment-analyzer-master/src/Procedures/SentiText.php';
require_once 'php-sentiment-analyzer-master/src/Config/Config.php';

require_once __DIR__ . '/Procedures/SentiText.php';
